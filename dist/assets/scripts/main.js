...
/***/ "./src/scripts/modules/PlayVideo.js":
/*!******************************************!*\
  !*** ./src/scripts/modules/PlayVideo.js ***!
  \******************************************/
/***/ (() => {
...
/***/ "./src/scripts/modules/ShowGallery.js":
/*!********************************************!*\
  !*** ./src/scripts/modules/ShowGallery.js ***!
  \********************************************/
/***/ (() => {
...
document.addEventListener('click', function (e) {
  if (e.target.closest('.js-show-gallery')) {
    e.target.closest('.category-tabs__content').querySelectorAll('.gallery-grid__col').forEach(function (t) {
    ...
    value: function setSelectedTab(currentTab) {
      ...
      this.tabs.forEach(function (el) {
        ...
        if (currentTab === tab) {
          ...
          _this2.tabpanels[_this2.tabs.indexOf(tab)].classList.remove('is-hidden');
          if (setFocus) {
            tab.focus();
          }
        } else {
          tab.setAttribute('aria-selected', 'false');
          tab.tabIndex = -1;
          _this2.tabpanels[_this2.tabs.indexOf(tab)].classList.add('is-hidden');
        }
      });
    }
  }, {
...
window.addEventListener('load', function () {
  var categoryTabs = document.querySelectorAll('.category-tabs');
  for (var i = 0; i < categoryTabs.length; i += 1) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initBenefitsSlider": () => (/* binding */ initBenefitsSlider),
/* harmony export */   "initMemorableSlider": () => (/* binding */ initMemorableSlider),
/* harmony export */   "initProgramSlider": () => (/* binding */ initProgramSlider),
/* harmony export */   "initSubscribeSlider": () => (/* binding */ initSubscribeSlider),
/* harmony export */   "initTabsSlider": () => (/* binding */ initTabsSlider)
/* harmony export */ });
...
function fillSliderProgress(sliderBlock, swiper) {
  var fillClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.sliderProgress.fill;
  var totalClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.sliderProgress.total;
  ...
  function handler() {
    ...
    fill.style.width = "".concat(progress * 100, "%");
  }
  swiper.on('slideChange', handler);
  handler();
}
function initBenefitsSlider() {
  var sliderBlockClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.benefits.sliderBlock;
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.benefits.slider;
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    spaceBetween: 16,
    speed: 700,
    keyboard: true,
    rewind: true
...
function initMemorableSlider() {
  var sliderBlockClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.memorable.sliderBlock;
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.memorable.slider;
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    navigation: {
      prevEl: ".".concat(_utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.memorable.btnPrev),
      nextEl: ".".concat(_utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.memorable.btnNext)
    },
    spaceBetween: 16,
    speed: 700,
    keyboard: true,
...
function initProgramSlider() {
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.program;
...
function initSubscribeSlider() {
  var _breakpoints;
  var sliderClass = _utils_classNames__WEBPACK_IMPORTED_MODULE_1__.classNames.slider.subscribe;
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".".concat(sliderClass), {
    ...
    centeredSlides: true,
    loop: true,
    breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.md, {
      slidesPerView: 3.6,
      spaceBetween: 20
    }), _defineProperty(_breakpoints, _utils_breakpoints__WEBPACK_IMPORTED_MODULE_2__.breakpointsMin.lg, {
      slidesPerView: 4.2,
      spaceBetween: 40
    }), _breakpoints)
  });
...
function initTabsSlider() {
  var sliderClass = document.querySelector('.js-tabs-slider');
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderClass, {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode],
    slidesPerView: 'auto',
    scrollbar: {
...
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders */ "./src/scripts/modules/sliders.js");
...
/* harmony import */ var _modules_Tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Tabs */ "./src/scripts/modules/Tabs.js");
...
/* harmony import */ var _modules_PlayVideo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/PlayVideo */ "./src/scripts/modules/PlayVideo.js");
/* harmony import */ var _modules_PlayVideo__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_PlayVideo__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_ShowGallery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/ShowGallery */ "./src/scripts/modules/ShowGallery.js");
/* harmony import */ var _modules_ShowGallery__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_ShowGallery__WEBPACK_IMPORTED_MODULE_5__);
...
// Sliders
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_1__.initBenefitsSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_1__.initMemorableSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_1__.initProgramSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_1__.initSubscribeSlider)();
(0,_modules_sliders__WEBPACK_IMPORTED_MODULE_1__.initTabsSlider)();

// Accordion
// eslint-disable-next-line
new handy_collapse__WEBPACK_IMPORTED_MODULE_0__["default"]();
